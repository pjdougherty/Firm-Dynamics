...
state_data = pd.read_csv(r'G:\Publications\Annual Regional Report\2015\bds_f_agest_release.csv')
metro_data = pd.read_csv(r'G:\Publications\Annual Regional Report\2015\bds_f_agemsa_release.csv')
us_data = pd.read_csv(r'G:\Publications\Annual Regional Report\2015\bds_f_age_release.csv')
